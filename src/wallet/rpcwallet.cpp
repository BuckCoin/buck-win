...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric) The Buck address is the key, the numeric amount in btc is the value\n"
            "      ,...\n"
            "    }\n"
...
UniValue getwalletinfo(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total confirmed Buck balance of the wallet\n"
            "  \"unconfirmed_balance\": xxx, (numeric) the total unconfirmed Buck balance of the wallet\n"
