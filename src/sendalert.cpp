...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client is out of date and potentially vulnerable to denial of service. Please update to the most recent version of Buck (1.0.5). More info at: https://z.cash/support/security.html";
    alert.strRPCError   = "Your client is out of date and potentially vulnerable to denial of service. Please update to the most recent version of Buck (1.0.5). More info at: https://z.cash/support/security.html";
